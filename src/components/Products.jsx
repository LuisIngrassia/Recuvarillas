        ...
        */}
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          {products.map((product) => (
            <div
              key={product.name}
              className="flex gap-5 rounded-xl border border-steel-200 bg-white p-4 sm:gap-6 sm:p-5 hover:shadow-lg transition-shadow"
            >
              <ProductCarousel
                media={product.media}
                alt={product.name}
              ...
              <div className="flex min-w-0 flex-1 flex-col">
                <h3 className="text-base sm:text-lg font-bold text-steel-800">
                  {product.name}
                </h3>
